...
import 'package:wirless_delivery/controller/notification/toall.dart';
...
class Notisendtoall extends StatelessWidget {
  const Notisendtoall({super.key});

  @override
  Widget build(BuildContext context) {
    Notivicationcontrollertoall controller =
        Get.put(Notivicationcontrollertoall());
    return Scaffold(
        ...
        body: GetBuilder<Notivicationcontrollertoall>(
